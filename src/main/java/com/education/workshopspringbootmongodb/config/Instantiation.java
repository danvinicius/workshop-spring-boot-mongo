...
import com.education.workshopspringbootmongodb.dto.AuthorDTO;
import com.education.workshopspringbootmongodb.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post1 = new Post(null, sdf.parse("21/03/2018"), "Partiu viagem!", "Partiu viajar para São Paulo", new AuthorDTO(maria));
